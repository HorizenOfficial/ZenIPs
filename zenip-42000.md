...
To ask the community the Owner can start in our [ZenIP Discourse forum](https://horizen.discourse.group/c/governance/proposal-discussions/15).
Once the Owner has asked the Horizen community as to whether an idea has
any chance of acceptance, a draft EonIP / ZenIP should be presented to the
Horizen Community via Discourse.
...
- Gustavo Fialho and Manon Boudox, representing the Horizen Foundation
- Rosario Pabst, representing the Horizen Labs Company
...
### ZenIP Process Overview

This document provides a high-level overview of the Horizen Improvement Proposal (ZenIP) process. However, it does not encompass all the details outlined in the comprehensive governance document. For an in-depth understanding of the ZenIP process, including proposal submission, discussion, voting, and implementation, please refer to the official [Horizen Constitution](https://docs.horizen.io/governance/overview/constitution). 
