...
ZenIP Editors will have to make a number of decision and unanimity cannot be assumed and is not necessary for all decisions.
...
-   The ZenIP draft must have been sent as a pull request (PR) to the ZenIP git repository.
...
Each new ZenIP, including all documentation, modifications, additions and patent rights, shall be contributed pursuant to the [Horizen Contributor License Agreement](https://github.com/ZencashOfficial/ZenIPs/blob/master/contributor_license_agreement.md). Please review the terms therein before submitting a ZenIP.

The Horizen Contributor License Agreement ensures that all contributions to the project
are made in a manner that complies with the intellectual property rights of third parties.
Contributors may not contribute intellectual property of third parties without having
permission to do so, typically under a license like the MIT License or BSD License. To
ensure compliance, contributors are required to provide details of the intellectual
property’s source and licensing scheme.
...
In this case, the ZenIP text is fully licensed under both the MIT license as well as the BSD License, and anyone may modify and redistribute the text provided they comply with the terms of either license. In other words, the license list is an "OR choice", not an "AND also" requirement.
...
Please reach out to [ZenIP@horizen.global](mailto:zenip@horizen.global) in case you want to contribute but are unwilling to use the license terms set forth herein. When compelling reasons are presented the ZenIP Editors may choose to add ZenIPs which are licensed differently, at their discretion.
